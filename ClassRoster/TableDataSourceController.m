...
//+ (NSArray *)classmate
//{
//    NSMutableArray *classmateArray = [NSMutableArray new];
//    NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"people" ofType:@"plist"];
//
//
//    if ([TableDataSourceController checkForPlistFileInDocs:@"classmates.plist"]) {  // Initial load
...
//        for (NSDictionary *classmate in [rootDictionary objectForKey:@"Classmates"]) {
//            ARClassmate *myClassmate = [[ARClassmate alloc] init]; // FIX!!!
//            [classmateArray addObject:myClassmate];
//        }
//    }
//    
//    [NSKeyedArchiver archiveRootObject:classmateArray toFile:plistPath];
//    
